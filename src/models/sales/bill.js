  ...
  Bill.init(
    {
      ...
      igstPercent: { type: DataTypes.DECIMAL(5, 2), defaultValue: 0 },
      ...
      cessPercent: { type: DataTypes.DECIMAL(5, 2), defaultValue: 0 },
      cessAmount: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
      totalTaxAmount: { type: DataTypes.DECIMAL(12, 2), defaultValue: 0 },
